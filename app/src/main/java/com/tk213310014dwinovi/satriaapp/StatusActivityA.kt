...
class StatusActivityA : AppCompatActivity() {
    private val mqttBroker = "tcp://free.mqtt.iyoti.id:1883"
    private val mqttTopicWaterLevel = "kali/tinggiair"
    private val mqttTopicRainCategory = "kali/rain_category"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_status_a)
        ...
        logoBack.setOnClickListener {
            Intent(this@StatusActivityA, MapsActivity::class.java)
            onBackPressed()
        }
    }
    ...
    fun openLocationLink(view: View) {
        val infoLokasi_a = "https://goo.gl/maps/6iJ2RrYmnt66kix26" //link lokasi

        val intent = Intent(Intent.ACTION_VIEW, Uri.parse(infoLokasi_a))
